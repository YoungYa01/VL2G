...
cd /home/youngya/projects/LISA

export HF_HUB_OFFLINE=1
export TRANSFORMERS_OFFLINE=1

OUT_ROOT="/mnt/d/research_vl2g/goose_train_1000"

mkdir -p "$OUT_ROOT/preds/lisa/traversable" "$OUT_ROOT/logs"

echo "[LISA] Running prompt 1: traversable for goose_train_1000"
...
CUDA_VISIBLE_DEVICES=0 python chat.py \
  ...
  < "$OUT_ROOT/lisa_inputs/lisa_prompt_1_traversable.txt" \
